...
if __name__ == "__main__":
    ...
    if mode == "predict":
        ...
        '''
        import os
        file_dir = './VOCdevkit/VOC2007/ImageSets/Segmentation/val.txt'
        with open(file_dir,'r')as f:
            file_list = f.readlines()
            file_list = ['./VOCdevkit/VOC2007/JPEGImages/'+i.replace('\n','')+'.jpg' for i in file_list]
        for file in file_list:
            try:
                ...
                segformer.detect_result(image, file.split('/')[-1].replace('.jpg','.txt'),count=count, name_classes=name_classes)
            # break
